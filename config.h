...
#define L_par (30000) //стартовая точка основного ряда с которой начинаем восстановление
#define lengthsrt (5000)
#define numimputevalue (100) // количество точек для восстановления
...
#define r_par floor(l_par/4) // ширина полосы Сако-Чиба (используется при расчете DTW и LB)
